...
def start(message):
    bot.send_message(message.chat.id, "attacks only work on sites hosted by cloudflare on nosec use up to 999 threads and up to 1200 attack seconds, otherwise you will break the rules and you will be blocked the developer of this bot @realmeagent is a free DDoS bot")
